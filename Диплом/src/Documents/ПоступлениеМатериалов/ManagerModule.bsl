...
Процедура Печатьдокумента(ТабДок, Ссылка) Экспорт
	...
	Макет = Документы.ПоступлениеМатериалов.ПолучитьМакет("ПечатьДокумента");
	Запрос = Новый Запрос;
	Запрос.Текст =
	"ВЫБРАТЬ
	|	ПоступлениеМатериалов.Дата,
	|	ПоступлениеМатериалов.ДоговорПоступления,
	|	ПоступлениеМатериалов.Контрагент,
	|	ПоступлениеМатериалов.Номер,
	|	ПоступлениеМатериалов.Организация,
	|	ПоступлениеМатериалов.Помещение,
	|	ПоступлениеМатериалов.Сумма,
